  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <button onClick={() => { setShowForm((s) => !s); if (!showForm) { setEditingId(null); reset(); setCatQuery(''); } }} className="h-10 px-4 rounded-lg bg-primary text-white text-sm font-bold">{showForm ? 'Close' : t('addExpense')}</button>
      </div>
      ...
      <Card>
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <select className="form-select rounded-lg bg-gray-100 dark:bg-gray-800 border-none focus:ring-primary" value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)}>
